        ...
        >
          ...
          <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 pointer-events-none flex justify-center">
            <img
              ...
              alt="Atatürk silüeti"
              className="h-20 w-auto object-contain opacity-0 scale-90 group-hover:opacity-40 group-hover:scale-100 transition-all duration-400 ease-out drop-shadow-md"
