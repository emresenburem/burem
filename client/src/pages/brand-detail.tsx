...
const BRANDS = [
  { name: "Baumüller",         color: "#009999", logo: `${WVL}baumuller.svg` },
  { name: "Siemens",           color: "#009999", logo: `${WVL}siemens.svg` },
  { name: "ABB",               color: "#FF0000", logo: `${WVL}abb.svg` },
  { name: "Schneider",         color: "#3dcd58", logo: `${WVL}schneider-electric.svg` },
  { name: "Fanuc",             color: "#FFD700", logo: `${WVL}fanuc.svg` },
  { name: "Yaskawa",           color: "#004098", logo: `${WVL}yaskawa-electric-corporation.svg` },
  { name: "Omron",             color: "#005EB8", logo: `${WVL}omron.svg` },
  { name: "Lenze",             color: "#0046AD", logo: `${WVL}lenze.svg` },
  { name: "Mitsubishi",        color: "#E60012", logo: `${WVL}mitsubishi.svg` },
  { name: "Danfoss",           color: "#E2000F", logo: `${WVL}danfoss.svg` },
  { name: "Delta",             color: "#003A8C", logo: `${WVL}delta-1.svg` },
  { name: "Beckhoff",          color: "#E30613", logo: `${WVL}beckhoff-logo.svg` },
  { name: "Allen Bradley",     color: "#CC0000", logo: `${WVL}allen-bradley.svg` },
  { name: "Fuji",              color: "#E60012", logo: `${WVL}fuji-electric.svg` },
  { name: "HAAS",              color: "#E60012", logo: `${WVL}haas-1.svg` },
  { name: "SEW",               color: "#003366", logo: `${WVL}sew-eurodrive.svg` },
  { name: "MAZAK",             color: "#E60012", logo: `${WVL}mazak.svg` },
  { name: "Rexroth",           color: "#003366", logo: `${WVL}rexroth.svg` },
  { name: "Panasonic",         color: "#003366", logo: `${WVL}panasonic.svg` },
  { name: "B&R",               color: "#003366", logo: "https://upload.wikimedia.org/wikipedia/commons/9/96/B%26R_Logo_Tagline_below_RGB_HD.jpg" },
  { name: "Control Techniques",color: "#00A04B", logo: `${WVL}control-techniques.svg` },
