...
import BursaSurucu from "@/pages/bursa-surucu-tamiri";
import ServoSurucu from "@/pages/servo-surucu-tamiri";
import InverterTamiri from "@/pages/inverter-tamiri";
import PlcTamiri from "@/pages/plc-tamiri";
import HmiTamiri from "@/pages/hmi-operator-panel-tamiri";
import ElektronikKartTamiri from "@/pages/endustriyel-elektronik-kart-tamiri";
import SiemensSurucu from "@/pages/siemens-surucu-tamiri";
import FanucServoSurucu from "@/pages/fanuc-servo-surucu-tamiri";
import AbbSurucu from "@/pages/abb-surucu-tamiri";
  ...
  return (
    <>
      <motion.button
        ...
        title="Kartvizit"
        aria-label="Dijital kartviziti görüntüle"
      >
                ...
                >
                  ...
                  >
                    <img
                      ...
                      alt="Burem Elektronik kartvizit ön yüzü — Burhanettin Şen ve Emre Şen iletişim bilgileri"
                  ...
                  >
                    <img
                      ...
                      alt="Burem Elektronik logosu kartvizit arka yüzü"
                      className="w-full h-full object-contain drop-shadow-2xl"
                      style={{ borderRadius: "6px" }}
                    />
                  </div>
...
function WhatsAppButton() {
  return (
    ...
    >
      <svg viewBox="0 0 32 32" className="h-8 w-8" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path
          fill="white"
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/bursa-surucu-tamiri" component={BursaSurucu} />
      <Route path="/servo-surucu-tamiri" component={ServoSurucu} />
      <Route path="/inverter-tamiri" component={InverterTamiri} />
      <Route path="/plc-tamiri" component={PlcTamiri} />
      <Route path="/hmi-operator-panel-tamiri" component={HmiTamiri} />
      <Route path="/endustriyel-elektronik-kart-tamiri" component={ElektronikKartTamiri} />
      <Route path="/siemens-surucu-tamiri" component={SiemensSurucu} />
      <Route path="/fanuc-servo-surucu-tamiri" component={FanucServoSurucu} />
